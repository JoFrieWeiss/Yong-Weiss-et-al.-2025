# =============================================================================
# Fig. 4 – Integrated comparison of TOC and DNA-projected biomass
# =============================================================================
#
# Description:
#   This script compares measured TOC with DNA-projected biomass and
#   evaluates their temporal patterns across individual lake cores.
#
# Panels:
#   Fig. 4a – TOC vs. DNA-projected biomass across lake cores
#   Fig. 4b – Integrated comparison of measured TOC and
#             DNA-projected biomass
#
# Analyses:
#   - Core-wise comparison of measured TOC and simulated biomass
#   - Spearman correlation analysis
#   - Paired Wilcoxon test
#   - Median ratio between simulated biomass and measured TOC
#   - Overall comparison of TOC and DNA-projected biomass
#
# Data:
