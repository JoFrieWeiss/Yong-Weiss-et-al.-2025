...
rda_scores_path <- "D:/document/DOC/AWI/Lake organic/data/Plat_PCARDA_with_scores_30.csv"
...
## -----------------------------------------------------------------------------
## FIGURE 6 & S7: Time-series of Biomass Contribution by Taxon
## -----------------------------------------------------------------------------
...
## -----------------------------------------------------------------------------
## FIGURE S3: TOC vs DNA-projected OC Time-series per Lake
## -----------------------------------------------------------------------------
...
## -----------------------------------------------------------------------------
## FIGURE S4 & S5: PCA of Viridiplantae Composition
## -----------------------------------------------------------------------------
...
plot_s4 <- ggplot(mean_scores, aes(x = PC1, y = PC2, color = Lake_group)) +
...
ggsave(file.path(figure_path, "FigS4_Viridiplantae_PCA.pdf"), plot_s4, width = 10, height = 7)
ggsave(file.path(figure_path, "FigS4_Viridiplantae_PCA.png"), plot_s4, width = 10, height = 7)


# --- FIGURE S5: PC1 Scores vs. Time ---
plot_s5 <- ggplot(site_scores_df, aes(x = Age, y = PC1)) +
...
ggsave(file.path(figure_path, "FigS5_PCA_scores.png"), plot_s5, width = 10, height = 8)
ggsave(file.path(figure_path, "FigS5_PCA_scores.pdf"), plot_s5, width = 10, height = 8)


## -----------------------------------------------------------------------------
## FIGURE S6: Redundancy Analysis (RDA)
## -----------------------------------------------------------------------------
...
ggsave(file.path(figure_path, "FigS6_RDA.pdf"), plot_s6, width = 12, height = 9)
ggsave(file.path(figure_path, "FigS6_RDA.png"), plot_s6, width = 12, height = 9)


## -----------------------------------------------------------------------------
## FIGURE S8: LMM/GLM Results for Burial Rates
## -----------------------------------------------------------------------------
...
final_s8_plot <- plot_grid(plot_total_br, plot_aquatic_br, plot_terrestrial_br, ncol = 1)

ggsave(file.path(figure_path, "Fig_S8_GLM_BR.png"), final_s8_plot, width = 16, height = 24, dpi = 300)
ggsave(file.path(figure_path, "Fig_S8_GLM_BR.pdf"), final_s8_plot, width = 16, height = 24)


## -----------------------------------------------------------------------------
## FIGURE S11: Time-series of Salicaceae and Rosaceae
## -----------------------------------------------------------------------------
...
combined_s11 <- plot_salicaceae / plot_rosaceae

ggsave(file.path(figure_path, "FigS11_Families.png"), combined_s11, width = 8, height = 6)
ggsave(file.path(figure_path, "FigS11_Families.pdf"), combined_s11, width = 8, height = 6)