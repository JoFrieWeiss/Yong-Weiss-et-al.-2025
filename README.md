...
- [`Data_Mining/Habitat/`](https://github.com/JoFrieWeiss/Yong-Weiss-et-al.-2025/tree/main/Data_Mining): Scripts for scraping species-level habitat metadata (e.g., from BacDive).
